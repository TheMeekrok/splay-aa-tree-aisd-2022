...
## 7.2. Вычислительный эксперимент
...
Пусть функция, описывающая производительность структур данных в зависимости от количества элементов $N$ - $F(x)$ для splay-дерева и $G(x)$ - для AA-дерева.

Как утверждалось ранее, в обоих деревья все операции выполняются не более, чем за $O(log_2N)$, т. е $F(x)$ и $G(X)$ возрастают не более, чем за $O(log_2N)$. Поэтому, **ожидается**, что на практике во всех провёденных тестах мы увидим рост функции не более, чем $O(log_2N)$.
...
<div>
    ...
    <p style="font-style: italic; text-align: center;">Рисунок 12.</p>
</div>
...
<div>
    ...
    <p style="font-style: italic; text-align: center;">Рисунок 13.</p>
</div>
...
<div>
    ...
    <p style="font-style: italic; text-align: center;">Рисунок 14.</p>
</div>
...
<div>
    ...
    <p style="font-style: italic; text-align: center;">Рисунок 15.</p>
</div>
