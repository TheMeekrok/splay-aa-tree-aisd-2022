...
- хранить данные
- иметь отдельный заголовочный файл, который будет управлять ей для считывания команд из файлом (в основном, для облегчения тестирования).
...
В динамических языках программирования (Python, JavaScript) выполнение происходит построчно, без компиляции, что сильно влияет на производительность.
